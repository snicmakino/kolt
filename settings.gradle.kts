...
// kolt-jvm-compiler-daemon is an independent Gradle build rather than a subproject.
...
includeBuild("kolt-jvm-compiler-daemon")

// kolt-native-compiler-daemon is the sidecar JVM process for konanc compilation, per
// ADR 0024. Same includeBuild rationale as kolt-jvm-compiler-daemon: independent
...
// changes.
includeBuild("kolt-native-compiler-daemon")
